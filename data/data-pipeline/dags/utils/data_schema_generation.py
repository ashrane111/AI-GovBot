...
def main():
    ...
    output_stats_path = os.path.join(output_dir, "segments_data_stats.txt")
    output_schema_path = os.path.join(output_dir, "segments_data_schema.pbtxt")  # Use .pbtxt format
