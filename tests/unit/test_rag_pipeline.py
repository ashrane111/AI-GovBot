...
def test_retriever_component(mock_config):
    ...
    with patch('langchain_community.vectorstores.FAISS.load_local') as mock_faiss:
        ...
        mock_vector_store.similarity_search_with_score.return_value = [
            (MagicMock(page_content="Document 1 content"), 0.2),
            (MagicMock(page_content="Document 2 content"), 0.5),
            (MagicMock(page_content="Document 3 content"), 0.8)
        ]
        ...
        assert docs == ["Document 1 content", "Document 2 content", "Document 3 content"]
