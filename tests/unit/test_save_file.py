...
class TestSaveFile(unittest.TestCase):
    ...
    def test_save_file_csv(self, mock_read_csv, mock_exists):
        ...
        with patch.object(SaveFile, 'save_as_csv') as mock_save:
    ...
    def test_save_file_pickle(self, mock_load, mock_exists):
        ...
        data = {"key": "value"}
        with patch.object(SaveFile, 'save_as_pickle') as mock_save:
    ...
    def test_save_file_faiss(self, mock_read, mock_exists):
        ...
        with patch.object(SaveFile, 'save_as_faiss') as mock_save:
