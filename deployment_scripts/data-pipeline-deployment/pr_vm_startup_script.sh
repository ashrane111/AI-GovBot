...
BRANCH=$(curl -s "http://metadata.google.internal/computeMetadata/v1/instance/attributes/branch" -H "Metadata-Flavor: Google" || echo "main")
git clone --branch "$BRANCH" https://github.com/ashrane111/AI-GovBot
